...
- [ ] 3. Remotion hello-world render (risk retirement)
...
- [ ] 5. VDSL validator — full rule set + `vf validate` (TDD)
...
- [ ] 6. VDSL compiler — storyboard.yaml → vdsl.yaml + RenderPlan (TDD)
...
- [ ] 7. Theme tokens + animation primitives + component registry
...
- [ ] 8. Motion components — batch A (Title, Paragraph, CodeBlock, Terminal, Image)
...
- [ ] 9. Motion components — batch B (FlowChart, Comparison, Timeline, Callout, EndCard)
...
- [ ] 10. Renderer wiring — Root + SceneSwitch + captions + audio
...
- [ ] 12. Runs, retry, resume, idempotency (TDD)
...
- [ ] 13. CLI verbs — vf new/status/approve/reject/rollback/resume
...
- [ ] 14. Render pipeline integration — vf preview / vf final
...
- [ ] 15. Benchmark project — 40s zh-CN CoT explainer
...
- [ ] 16. Reproducibility regression + §62.4 acceptance scripts
